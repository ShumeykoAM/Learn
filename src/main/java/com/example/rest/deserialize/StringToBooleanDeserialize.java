package com.example.rest.deserialize;
...
public class StringToBooleanDeserialize extends JsonDeserializer<Boolean>
{
	...
	@Override public Boolean deserialize(JsonParser p, DeserializationContext ctxt) throws IOException, JsonProcessingException
	{
		Boolean result = null;
